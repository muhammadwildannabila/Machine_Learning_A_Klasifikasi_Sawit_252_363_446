# vit_b16_finetune.py
# ==========================================================
# ViT-B/16 - FINE-TUNING (2-stage)
# Stage 1: freeze backbone (warmup)
# Stage 2: unfreeze last N transformer blocks (+ head)
# ==========================================================
...
def unfreeze_last_blocks(model, n_blocks=2):
    # timm ViT biasanya punya model.blocks (list)
    for p in model.parameters():
        p.requires_grad = False
    ...
    # layernorm akhir kadang membantu
...
def main():
    ...
    ap.add_argument("--out_dir", default="out_vit_b16_finetune", type=str)
    ...
    ap.add_argument("--unfreeze_blocks", default=2, type=int)
    ...
    plt.title("Confusion Matrix - ViT-B/16 Fine-tuning")
    ...
    print(f"[ViT-B/16 FINETUNE] Test Acc={te_acc:.4f} | Macro-F1={mf1:.4f} | Saved -> {out_dir}")
