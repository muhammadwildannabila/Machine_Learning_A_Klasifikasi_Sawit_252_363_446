# classic_svm_normal.py
# ============================================
# Classic Normal (Pixel Flatten) - SVM (RBF)
...
def main():
    ...
    parser.add_argument("--out_dir", type=str, default="outputs_classic_svm")
    ...
    plot_cv_results(grid, out_dir/"figs"/"cv_top10.png", "SVM (RBF) CV Top-10 (macro-F1)")
    ...
    plt.title("Confusion Matrix - SVM (Pixel Flatten)")
