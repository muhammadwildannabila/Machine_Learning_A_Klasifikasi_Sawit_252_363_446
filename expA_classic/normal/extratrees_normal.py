# classic_extratrees_normal.py
# ============================================
# Classic Normal (Pixel Flatten) - ExtraTrees
...
def main():
    ...
    parser.add_argument("--out_dir", type=str, default="outputs_classic_et")
    ...
    plot_cv_results(grid, out_dir/"figs"/"cv_top10.png", "ExtraTrees CV Top-10 (macro-F1)")
    ...
    plt.title("Confusion Matrix - ExtraTrees (Pixel Flatten)")
    ...
    summary = {
        "model": "ExtraTrees_pixel_flatten",
