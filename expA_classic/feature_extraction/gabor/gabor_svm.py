# gabor_svm.py
# ============================================
# Feature Extraction (GABOR) + SVM (RBF)
# ============================================
...
def main():
    ...
    parser.add_argument("--out_dir", type=str, default="out_gabor_svm")
    ...
    plot_cv_results(grid, out_dir/"figs"/"cv_top10.png", "GABOR + SVM (RBF) CV Top-10 (macro-F1)")
    ...
    plt.title("Confusion Matrix - GABOR + SVM")
