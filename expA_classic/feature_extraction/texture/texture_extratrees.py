# texture_extratrees.py
# ============================================
# Feature Extraction (TEXTURE: GLCM + LBP) + ExtraTrees
# ============================================
...
def main():
    ...
    parser.add_argument("--out_dir", type=str, default="out_texture_et")
    ...
    plot_cv_results(grid, out_dir/"figs"/"cv_top10.png", "TEXTURE + ExtraTrees CV Top-10 (macro-F1)")
    ...
    plt.title("Confusion Matrix - TEXTURE + ExtraTrees")
