# color_extratrees.py
# ============================================
# Feature Extraction (COLOR) + ExtraTrees
# ============================================
...
def extract_Xy(items, img_size=224, bins=16):
    ...
    for path, cls in items:
        try:
            ...
            feat = color_features_cv2(img, bins=bins) if cv2 is not None else color_features_pil(img, bins=bins)
...
def main():
    ...
    parser.add_argument("--out_dir", type=str, default="out_color_et")
    ...
    plot_cv_results(grid, out_dir/"figs"/"cv_top10.png", "COLOR + ExtraTrees CV Top-10 (macro-F1)")
    ...
    plt.title("Confusion Matrix - COLOR + ExtraTrees")
